...
const translations = {
    ...
    en: {
        ...
        heroSubtitle: "YOUR NEXT CHAPTER BEGINS IN KINGDOM 500",
...
"Experienced officers, daily communication and clear organization.",
        ...
        applyText:
`You can reach us via Discord or the application form.<br><br>
...
Apply directly.`,
    ...
    ru: {
        ...
        heroSubtitle: "ВАША НОВАЯ ГЛАВА НАЧИНАЕТСЯ В KINGDOM 500",
...
Каждый игрок важен.<br>
Каждая KvK тщательно планируется.<br>
Каждая победа достигается вместе.`,
...
"Опытные офицеры, ежедневное общение и четкая организация.",
        ...
        applyText:
`Свяжитесь с нами через Discord или заполните форму заявки.<br><br>
